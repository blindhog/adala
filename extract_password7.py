...
for file in file_list:
    ...
    iosparse.print_list(iosparse.generate_header_h2("{} Level 7 Encryption Configurations".format(hostname)))
    iosparse.print_list(iosparse.get_password7_configs(file))
